...
int** Make_TSPMatrix()
{
	...
	cout << "Матрица с расстояниями между торговыми площадками: \n";
	Print_Matrix(matrix);
	return matrix;
}
...
void Print_Result()
{
	...
	cout << "\nКратчайшее растояние между торговыми площадками = " << sum << "км" << endl;;
}
...
void makeGraph()
{
	...
	cout << "Введите количество торговых площадок: "; cin >> amountVerts;
	cout << "Введите количество дорог между торговыми площадками: "; cin >> amountEdges;
	...
	{
		cout << "Начальная площадка: "; cin >> sourceVertex;
		cout << "Конечная площадка: "; cin >> targetVertex;
		cout << "Расстояние между торговыми площадками: "; cin >> edgeWeight;
